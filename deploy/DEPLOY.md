...
For production auth, set `BOOTSTRAP_ADMIN_NAME`, one of `BOOTSTRAP_ADMIN_PHONE` / `BOOTSTRAP_ADMIN_EMAIL`, `BOOTSTRAP_ADMIN_PASSWORD_HASH`, and `APP_SECURE_COOKIE=true`.
